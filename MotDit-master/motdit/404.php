  ...
  <header id="header">
        ...
        <div class="header_top">
          <div class="header_top_left">
            <ul class="top_nav">
              ...
              <li><a href="pages/contact.html">Nous Rejoindre</a></li>
            </ul>
          </div>
          <div class="header_top_right">
            <p>Jeudi, 09 Novembre 2017</p>
          </div>
        </div>
      </div>
    </div>
   ...
   <section id="presentation">   
        <div class="row">
            ...
            <img id="logo" src="images/motdit_logo.jpg">
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6">
    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav main_nav">
          ...
          <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Cégep</a>
            <ul class="dropdown-menu" role="menu">
              <li><a href="#">Vie Étudiante</a></li>
              <li><a href="#">Association</a></li>
              <li><a href="#">Politique</a></li>
              <li><a href="#">Agecem</a></li>
              <li><a href="#">Publicités</a></li>
            </ul>
          </li>
          <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">International</a>
            <ul class="dropdown-menu" role="menu">
              <li><a href="#">Politique</a></li>
            </ul>
          </li>
          <li><a href="#">Éducation</a></li>
          <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Loisirs</a>
            <ul class="dropdown-menu" role="menu">
              <li><a href="#">Arts</a></li>
